...
/** tento soubor je seznam použitých rozměrů knihovnou compose */
...
val DRINK_ITEM_HEIGHT = 250.dp
val SMALL_DRINK_ITEM_HEIGHT = 150.dp
val INGREDIENT_ITEM_HEIGHT = 100.dp
